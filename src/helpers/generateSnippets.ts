...
import componentsSnippets, { ComponentsSnippet } from "../sourceSnippets/components";
...
import propTypesSnippets, { PropTypesSnippet } from "../sourceSnippets/propTypes";
...
import typescriptSnippets, { TypescriptSnippet } from "../sourceSnippets/typescript";
...
const getSnippets = () => {
    ...
    return replaceSnippetPlaceholders(JSON.stringify(snippets, null, 4));
};
