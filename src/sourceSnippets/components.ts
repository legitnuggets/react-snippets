...
const reactFunctionalExportComponent: ComponentsSnippet = {
    ...
    prefix: "rfce",
    body: [...react, "", `function ${Placeholders.FileName}() {`, ...innerComponent, "}", ...exportDefault],
...
const reactFunctionalComponent: ComponentsSnippet = {
    ...
    prefix: "rfc",
    body: [...react, "", `export default function ${Placeholders.FileName}() {`, ...innerComponent, "}", ""],
    description: "Creates a React Functional Component with ES7 module system",
};
...
const reactArrowFunctionExportComponent: ComponentsSnippet = {
    ...
    prefix: "rafce",
    body: [...react, "", `const ${Placeholders.FileName} = () => {`, ...innerComponent, "}", ...exportDefault],
...
const reactArrowFunctionComponent: ComponentsSnippet = {
    ...
    prefix: "rafc",
    body: [...react, "", `export const ${Placeholders.FileName} = () => {`, ...innerComponent, "}", ""],
    description: "Creates a React Arrow Function Component with ES7 module system",
};
