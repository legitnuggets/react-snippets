...
const importEverything: ImportsSnippet = {
    ...
    prefix: "ime",
    body: [`import * as ${Placeholders.SecondTab} from '${Placeholders.FirstTab}'`],
};

const importAs: ImportsSnippet = {
    key: "importAs",
    prefix: "ima",
    body: [`import { ${Placeholders.SecondTab} as ${Placeholders.ThirdTab} } from '${Placeholders.FirstTab}'`],
};
