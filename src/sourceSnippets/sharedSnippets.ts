...
export const reactWithReduxConnect = ["import React from 'react'", "import { connect } from 'react-redux'"];
...
export const propsStateInterface = [...propsTypeInterface, ...stateTypeInterface];
