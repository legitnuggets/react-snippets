...
const exportDestructing: OthersSnippet = {
    ...
    prefix: "exd",
    body: [`export { ${Placeholders.SecondTab} } from '${Placeholders.FirstTab}'`],
};

const exportAs: OthersSnippet = {
    key: "exportAs",
    prefix: "exa",
    body: [`export { ${Placeholders.SecondTab} as ${Placeholders.ThirdTab} } from '${Placeholders.FirstTab}'`],
};

const exportNamedFunction: OthersSnippet = {
    key: "exportNamedFunction",
    prefix: "enf",
    body: [`export const ${Placeholders.FirstTab} = (${Placeholders.SecondTab}) => {${Placeholders.ThirdTab}}`],
...
const exportDefaultFunction: OthersSnippet = {
    ...
    prefix: "edf",
    body: [`export default (${Placeholders.FirstTab}) => {${Placeholders.SecondTab}}`],
...
const exportDefaultNamedFunction: OthersSnippet = {
    ...
    prefix: "ednf",
    body: [`export default function ${Placeholders.FirstTab}(${Placeholders.SecondTab}) {${Placeholders.ThirdTab}}`],
...
const method: OthersSnippet = {
    key: "method",
    prefix: "met",
    body: [`${Placeholders.FirstTab} = (${Placeholders.SecondTab}) => {${Placeholders.ThirdTab}}`],
...
const propertyGet: OthersSnippet = {
    key: "propertyGet",
    prefix: "pge",
    body: [`get ${Placeholders.FirstTab}() {`, `    return this.${Placeholders.SecondTab}`, "}"],
...
const propertySet: OthersSnippet = {
    key: "propertySet",
    prefix: "pse",
    body: [`set ${Placeholders.FirstTab}(${Placeholders.SecondTab}) {${Placeholders.ThirdTab}}`],
...
const forEach: OthersSnippet = {
    key: "forEach",
    prefix: "fre",
    body: [`${Placeholders.FirstTab}.forEach(${Placeholders.SecondTab} => {${Placeholders.ThirdTab}})`],
...
const forOf: OthersSnippet = {
    key: "forOf",
    prefix: "fof",
    body: [`for(let ${Placeholders.FirstTab} of ${Placeholders.SecondTab}) {${Placeholders.ThirdTab}}`],
...
const forIn: OthersSnippet = {
    key: "forIn",
    prefix: "fin",
    body: [`for(let ${Placeholders.FirstTab} in ${Placeholders.SecondTab}) {${Placeholders.ThirdTab}}`],
...
const namedFunction: OthersSnippet = {
    key: "namedFunction",
    prefix: "nfn",
    body: [`const ${Placeholders.FirstTab} = (${Placeholders.SecondTab}) => { ${Placeholders.ThirdTab} }`],
...
const setInterval: OthersSnippet = {
    key: "setInterval",
    prefix: "sti",
    body: [`setInterval(() => { ${Placeholders.FirstTab} }, ${Placeholders.SecondTab})`],
...
const setTimeOut: OthersSnippet = {
    key: "setTimeOut",
    prefix: "sto",
    body: [`setTimeout(() => { ${Placeholders.FirstTab} }, ${Placeholders.SecondTab})`],
...
const promise: OthersSnippet = {
    key: "promise",
    prefix: "prom",
    body: [`return new Promise((resolve, reject) => { ${Placeholders.FirstTab} })`],
...
const shouldComponentUpdate: OthersSnippet = {
    ...
    prefix: "scu",
    body: [`shouldComponentUpdate(nextProps, nextState) { ${Placeholders.FirstTab} }`],
...
const componentDidUpdate: OthersSnippet = {
    ...
    prefix: "cdup",
    body: [`componentDidUpdate(prevProps, prevState) { ${Placeholders.FirstTab}} `],
...
const getDerivedStateFromProps: OthersSnippet = {
    ...
    prefix: "gdsfp",
    body: [`static getDerivedStateFromProps(props, state) {${Placeholders.FirstTab}}`],
...
const getSnapshotBeforeUpdate: OthersSnippet = {
    ...
    prefix: "gsbu",
    body: [`getSnapshotBeforeUpdate = (prevProps, prevState) => {${Placeholders.FirstTab}}`],
...
const componentSetStateFunc: OthersSnippet = {
    ...
    prefix: "ssf",
    body: [`this.setState((state, props) => { return { ${Placeholders.FirstTab} }})`],
    description: "Performs a shallow merge of nextState into current state",
};
...
const bindThis: OthersSnippet = {
    key: "bindThis",
    prefix: "bnd",
    body: [`this.${Placeholders.FirstTab} = this.${Placeholders.FirstTab}.bind(this)`],
