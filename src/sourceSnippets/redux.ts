...
const mappingToProps: ReduxSnippet = {
    key: "mappingToProps",
    prefix: "reduxmap",
    body: ["const mapStateToProps = (state) => ({})", "", "const mapDispatchToProps = {}"],
};

export default [importReduxConnect, reduxAction, reduxConst, reduxReducer, reduxSelector, reduxSlice, mappingToProps];
