...
const describeBlock: TestsSnippet = {
    key: "describeBlock",
    prefix: "desc",
    body: [`describe('${Placeholders.FirstTab}', () => { ${Placeholders.SecondTab} })`],
    description: "Testing `describe` block",
};
const testBlock: TestsSnippet = {
    key: "testBlock",
    prefix: "test",
    body: [`test('should ${Placeholders.FirstTab}', () => { ${Placeholders.SecondTab} })`],
    description: "Testing `test` block",
};
const testAsyncBlock: TestsSnippet = {
    key: "testAsyncBlock",
    prefix: "testa",
    body: [`test('should ${Placeholders.FirstTab}', async () => { ${Placeholders.SecondTab} })`],
    description: "Testing `asynchronous test` block",
};
const itBlock: TestsSnippet = {
    key: "itBlock",
    prefix: "tit",
    body: [`it('should ${Placeholders.FirstTab}', () => { ${Placeholders.SecondTab} })`],
    description: "Testing `it` block",
};
const itAsyncBlock: TestsSnippet = {
    key: "itAsyncBlock",
    prefix: "tita",
    body: [`it('should ${Placeholders.FirstTab}', async () => { ${Placeholders.SecondTab} })`],
