...
const showRestartMessage = async ({ affectsConfiguration }: ConfigurationChangeEvent) => {
...
export async function activate(context: ExtensionContext) {
    ...
    const snippetSearchCommand = commands.registerCommand("reactSnippets.search", snippetSearch);
